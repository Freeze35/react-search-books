...
module.exports = (env, argv) => {
    ...
    /** @type {{mode: string, devtool: (string|boolean), output: {chunkFilename: string, filename: string}, performance: {assetFilter: (function(*): boolean)}, optimization: {minimizer: (TerserPlugin<import("terser").MinifyOptions>|CssMinimizerPlugin<CssNanoOptionsExtended>)[]}, plugins: CompressionPlugin<import("zlib").ZlibOptions>[]}} */
